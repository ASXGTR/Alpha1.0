...
**This project is in active development — currently in a -pre-alpha_ build stage.**  
Alpha1.0
...
All game code, assets, and documentation in this repository are licensed under the  
**Creative Commons Attribution-NonCommercial 4.0 International License (CC BY-NC 4.0)**.

You may:
- Share and adapt the work non-commercially
- Credit the author (John Murphy)
- Link to the license and indicate changes

You may not:
- Use any part of this project for commercial purposes
- Monetize, resell, or redistribute without explicit permission
