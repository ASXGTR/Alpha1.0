...
public class SeedItemDatabase : ScriptableObject
{
    ...
    public List<SeedItemEntry> seedItems = new()
    {
        ...
        new SeedItemEntry {
            ...
            icon = null,
            cropPrefab = null, // Replace with actual prefab reference
            growthTimeDays = 7f,
            maxYield = 1,
            regrowsAfterHarvest = false,
            requiresFertilizer = true,
    ...
    icon = null,
    cropPrefab = null, // Replace with actual orange tree prefab when ready
    growthTimeDays = 6f,
    maxYield = 2,
    regrowsAfterHarvest = false,
    requiresFertilizer = true,
...
new SeedItemEntry {
    ...
    icon = null,
    cropPrefab = null, // Replace with actual sweetcorn crop prefab when ready
    growthTimeDays = 5f,
    maxYield = 3,
    regrowsAfterHarvest = false,
    requiresFertilizer = true,
